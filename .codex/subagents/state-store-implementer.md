# State Store Implementer

## Role
State Store Implementer — routing persona для scoped APPLY-исполнения.

## When to use
Когда workpack сфокусирован на Zustand slices, selectors, async actions и state decomposition.
...
- `src/main/**`
- `src/preload/**`
- Неподтверждённые UI/runtime правки
